...
export default function Menu() {
  ...
  return (
    <div className="bg-white p-[16px] rounded-lg w-[360px]">
      <div className='flex items-center justify-between'>
        <div className="text-2xl font-bold">Thông báo</div>
        <div className='w-8 h-8 rounded-full hover:bg-gray-200 flex items-center justify-center cursor-pointer'><img src={threeDot} /></div>
      </div>
