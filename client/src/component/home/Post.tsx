    ...
    <div className="rounded-xl bg-white border border-gray-200 shadow-xl mt-4">
      ...
      <div
        ...
        <div>
          ...
          <div className="text-[#65676B] text-[13px] flex items-center gap-3  ">
            <div>Hoàng Hải Nam</div> <div>3 ngày</div>{" "}
      ...
      <div className="w-full overflow-hidden flex items-center object-cover">
        <img
          ...
          src="https://newsmd2fr.keeng.net/tiin/archive/imageslead/2022/06/25/90_ae7ba41c420547840d43c76d2e0c7da0.jpg"
        />
      </div>
      ...
      <div className="grid grid-cols-3 h-11 w-[90%] mx-auto border-t border-gray-300 relative">
        <div onMouseOver={()=>setShowIcon(true)} onMouseLeave={()=>setShowIcon(false)} className="text-gray-500 font-semibold flex items-center justify-center gap-2 cursor-pointer py-2 h-[80%] my-auto hover:bg-gray-300 rounded">
          <div className="like font-semibold"></div>Thích
          {showIcon&&<div className="absolute -top-[45px] left-0 bg-white rounded-3xl shadow-xl border border-gray-300"><IconLike/></div>}
        </div>
